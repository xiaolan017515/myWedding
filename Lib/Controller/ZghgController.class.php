...
class ZghgController extends WeixinController{
    ...
    public function __construct(){
        $this->token = 'zghg';
        $this->appid = 'wx7d18c83184806516';
        $this->secret = 'cd91ac44cb2013a8318ef12d41b96ddc';
        $this->conn =  db::getConn();
        $this->custom = new CustomController();
        $this->sale = new SaleController();
        $this->source = 'zghg';
        $this->dir = __DIR__.'/../Public/zghg';
        if(!is_dir($this->dir)){
    ...
    */
    ...
    public function sendNew($msg){
        ...
        $data = array(
            '0'=>array(
                "Title"=>"欢迎“{$base_info['nickname']}”关注中国会馆V慧品！", 
                "Description"=>"欢迎”{$base_info['nickname']}“关注紫檀V慧品！", 
                "PicUrl"=>"http://wx.iisun.net/hpjr/Lib/Tml/zhongguohuiguan.png", 
                "Url" =>"http://wx.iisun.net/hpjr/zhongguohuiguan/sucai/zghgdatu.html"
            ),
            '1'=>array(
