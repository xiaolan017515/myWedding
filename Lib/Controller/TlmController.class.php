...
class TlmController extends WeixinController{
    ...
    public function __construct(){
        $this->token = 'tlm';
        $this->appid = 'wx23f91f4807ffaaed';
        $this->secret = '652f955c30ae92f90bf6e36a8fc40e41';
        $this->conn =  db::getConn();
        $this->custom = new CustomController();
        $this->sale = new SaleController();
        $this->dir = __DIR__.'/../Public/tlm';
        if(!is_dir($this->dir)){
    ...
    */
    ...
    public function receiveCode(){
        ...
        if(!is_null($code) &&  !is_null($state)){
            ...
            $sql = "select url from menu where id = '%d' and source = 'tianlunmei' ";
    ...
    */
    ...
    public function sendNew($msg){
        ...
        $data = array(
            '0'=>array(
                "Title"=>"欢迎“{$base_info['nickname']}”关注天伦美V慧品！", 
                "Description"=>"欢迎“{$base_info['nickname']}”关注天伦美V慧品！", 
                "PicUrl"=>"http://wx.iisun.net/hpjr/Lib/Tml/tianlunmei.png", 
                "Url" =>"http://wx.iisun.net/hpjr/tianlunmei/sucai/tlmdatu.html"
            ),
            '1'=>array(
    ...
    public function senLoanMsg($data){
        $tem = array(
            'touser'=>$data['openid'].'',
            'template_id'=>'h6yUf3YBXr5ZNkE3sn6vzvshp6kDWs6XUp2GX28pI6g',
            'topcolor'=>'#F08300',
            'data'=>array(
                'first'=>array(
