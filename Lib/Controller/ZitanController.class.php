...
class ZitanController extends WeixinController{
    ...
    public function __construct(){
        $this->token = 'zitan';
        $this->appid = 'wx195e0960c65caad9';
        $this->secret = 'a9ca4fcadb1360434199df663cf93901';
        $this->conn =  db::getConn();
        $this->custom = new CustomController();
        $this->sale = new SaleController();
        $this->source = 'zitan';
        $this->dir = __DIR__.'/../Public/zitan';
        if(!is_dir($this->dir)){
    ...
    */
    ...
    public function sendNew($msg){
        ...
        $data = array(
            '0'=>array(
                "Title"=>"欢迎“{$base_info['nickname']}”关注紫檀V慧品！", 
                "Description"=>"欢迎”{$base_info['nickname']}“关注紫檀V慧品！", 
                "PicUrl"=>"http://wx.iisun.net/hpjr/Lib/Tml/zitan.png", 
                "Url" =>"http://wx.iisun.net/hpjr/zitan/sucai/zitandatu.html"
            ),
            '1'=>array(
