...
/**
 * Polyfill for stopAnimFrame stop animate
 */
RainyDay.prototype.stopAnimFrame = function() {

	window.requestAnimFrame = () => {
		window.cancelAnimationFrame(window.requestAnimFrame); //可以取消该次动画。
	};
};
